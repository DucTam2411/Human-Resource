...
-- add birth_place
ALTER TABLE EMPLOYEE 
ADD BIRTH_PLACE NVARCHAR(100);

UPDATE EMPLOYEE
SET BIRTH_PLACE = 'Vakanla'


-- update brith_date
UPDATE EMPLOYEE
SET BIRTH_DATE = '2020-11-1'
...
-- add employee academic_level
ALTER TABLE EMPLOYEE 
ADD ACADEMIC_LEVEL NVARCHAR(150);

UPDATE EMPLOYEE
SET ACADEMIC_LEVEL= 'Graduated college'
